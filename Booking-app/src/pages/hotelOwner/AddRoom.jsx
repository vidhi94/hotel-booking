  ...
  return (
    <form>
       <Title align='left' font='outfit' title='Add Room'
        subTitle='Fill in the details carefully nd accurate room details, pricing, and amenities, to enhance the user booking experience.'/>
        ...
        <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
          <div className='flex-1 max-w-48'>
            ...
            <select onChange={(e)=> setInputs({...inputs, roomType: e.target.value})} className='order opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
