    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
       ...
       <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
            <h1 className='text-3xl md:text-4xlfont-playfair'>Experience Luxury Like Never Before</h1>
      ...
      {/* Common Specifictions */}
        ...
        <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
                <img src='https://png.pngtree.com/template/20190119/ourmid/pngtree-abstract-logo-image_52740.jpg' alt="Host" className='h-14 w-14 md:h-18 md:w-18 rounded-full'/>
              <div>
