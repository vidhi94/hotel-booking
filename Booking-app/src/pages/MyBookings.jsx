...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-35'>
       <Title title='My-Bookings' subTitle='Eaily manage your past, current, and upcoming hotel reservations
