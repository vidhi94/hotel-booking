...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Dashboard' subTitle='Monitro your room listings, track bookingsand analyze
         revenue-allin one place, Stay update with real-time lisights to ensure smooth operations.'/>

         <div className='flex gap-4 my-8'>
            {/* -------------Total Bookings------------- */}
            <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
               <img src={assets.totalBookingIcon} alt="" className='max-sm:hiddenh-10'/>
