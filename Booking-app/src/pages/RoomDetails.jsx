...
const RoomDetails = () => {
    ...
    return room && (
        <div className='py-28  md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            {/* Room Address */}
            <div className='flex items-center gap-1 text-gray-500mt-2'>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all
                 text-white rounded-md max-w:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer '>Check Availability</button>
            </form>
           ...
           <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
              <p>Guests will be allocated on the ground floor according to avalability.
                 ...
                 floor according to avalability. You get the comfortable two bedroom
           ...
           <div className='flex flex-col items-start gap-4'>
              <div className='flex gap-4'>
                <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRTlRgmFKiVxZuRFXpF1zTg6XjyzzkS1UhxQ&s' alt="Host" className='h-14 w-14 md:h-18 md:w-18 rounded-full'/>
                <div>
                    <p>Hotel By {room.hotel.name}</p>
              ...
              <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary-dull transition-all cursor-po'>Contct Now</button>
           </div>
